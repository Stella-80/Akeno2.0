...
class Config(object):
    ...
    SUDO_USERS = '1461968113,1603318426'  # List of id's -  (not usernames) for users which have sudo access to the bot.
    DEV_USERS = '1461968113,1603318426'  # List of id's - (not usernames) for developers who will have the same perms as the owner
    SUPPORT_USERS = '1461968113,1603318426'  # List of id's (not usernames) for users which are allowed to gban, but can also be banned.
    WHITELIST_USERS = '1461968113,1603318426' # List of id's (not usernames) for users which WONT be banned/kicked by the bot.
